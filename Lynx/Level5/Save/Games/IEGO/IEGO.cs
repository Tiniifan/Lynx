...
namespace Lynx.Level5.Save.Games.IEGO
{
    public class GO : IGame
    {
        ...
        public GO(Stream data, Dictionary<int, Level5.Save.Logic.Player> players, Dictionary<int, Level5.Save.Logic.Move> moves, Dictionary<int, Level5.Save.Logic.Avatar> avatars, bool isJP)
        {
            Players = players;
            Avatars = avatars;
            Moves = moves;
