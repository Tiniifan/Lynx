...
namespace Lynx.Level5.Save.Games.IEGOCS
{
    public class CS : IGame
    {
        ...
        public CS(Stream data, Dictionary<int, Level5.Save.Logic.Player> players, Dictionary<int, Level5.Save.Logic.Move> moves, bool isJP)
        {
