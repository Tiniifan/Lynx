...
namespace Lynx.Level5.Save.Games.IEGOGalaxy
{
    public class Galaxy : IGame
    {
        ...
        public Galaxy(Stream data, Dictionary<int, Level5.Save.Logic.Player> players, Dictionary<int, Level5.Save.Logic.Move> moves)
        {
