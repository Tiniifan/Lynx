...
namespace Lynx.InazumaEleven.Save.Games.IEGOCS
{
    public class CS : IGame
    {
        ...
        private List<Player> GetPlayers()
        {
            ...
            List<Player> players = playerBlocks
                .Where(playerBlock => Players.Keys.Contains(Convert.ToInt32(playerBlock.ID)))
                .Select(playerBlock =>
                {
                    Player player = new Player(Players[Convert.ToInt32(playerBlock.ID)]);
                    ...
                    player.Moves = playerBlock.Moves
                        .Select(moveBlock => new Move(Moves.TryGetValue((int)moveBlock.MoveID, out var move) ? move : Moves[0x0], moveBlock.MoveLevel, moveBlock.MoveLearned, moveBlock.MoveUsage))
                        .ToList();

                    player.Avatar = new Avatar(Avatars[(int)playerBlock.AvatarID], playerBlock.AvatarLevel, playerBlock.AvatarUsage);
        ...
        private void SaveSaveInfo(BinaryDataWriter writer)
        {
            ...
            if (SaveInfo.UnlockAllData == true)
            {
                if (helper.IsJP)
                {
                    writer.Seek(0x2AB); //Special Download
                    writer.Write(new byte[6] { 0xFF, 0xFF, 0x01, 0x00, 0xFE, 0x3F });

                    writer.Seek(0x2B5); //go link
                    writer.Write(new byte[6] { 0xE0, 0xF8, 0xFF, 0xFF, 0x0F, 0xFF });

                    writer.Seek(0x2D2); //phone new notification jp:0x2D2
                    writer.Write((byte)0x18);

                    writer.Seek(0x2DF); //wifi 
                    ...
                    // Ugly Write
                    writer.Seek(0x242B4);
                    writer.Write(new byte[768] {  });
                }
                else
                {
        ...
        private BestMatch IsBestMatch(int tryPlayerID, int tryAuraID)
        {
        ...
        public CS(Stream data, Dictionary<int, InazumaEleven.Save.Logic.Player> players, Dictionary<int, InazumaEleven.Save.Logic.Move> moves, bool isJP)
        {
