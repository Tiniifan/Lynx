...
namespace Lynx.InazumaEleven.Save.Games.IEGOGalaxy
{
    public class Galaxy : IGame
    {
        ...
        private List<Player> GetPlayers()
        {
            ...
            List<Player> players = playerBlocks
                ...
                .Select(playerBlock =>
                {
                    ...
                    {
                        player.Avatar = new Avatar(Avatars[(int)playerBlock.TotemID], 1, 1);
                    } else
                    {
        ...
        public Galaxy(Stream data, Dictionary<int, InazumaEleven.Save.Logic.Player> players, Dictionary<int, InazumaEleven.Save.Logic.Move> moves)
        {
